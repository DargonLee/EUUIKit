...
#import "EUNavigationAnimation.h"
...
@interface EUNavigationController ()<UIGestureRecognizerDelegate,UINavigationControllerDelegate>
...
@property(strong,nonatomic) EUNavigationAnimation * animationController;
...
#pragma lazy
- (EUNavigationAnimation *)animationController
{
    if (_animationController == nil) {
        _animationController = [[EUNavigationAnimation alloc]init];
