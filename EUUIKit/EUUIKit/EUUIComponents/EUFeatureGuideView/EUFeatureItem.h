...
typedef NS_ENUM(NSUInteger, EUFeatureItemAlignmentPriority) {
    EUFeatureItemAlignmentBottomFirst, //底部优先
    EUFeatureItemAlignmentTopFirst, //顶部优先
};

@interface EUFeatureItem : NSObject
...
//单布局元素在界面上垂直居中时，是将介绍文案布局顶部，还是底部
@property (nonatomic ,assign) EUFeatureItemAlignmentPriority introduceAlignmentPriority;
